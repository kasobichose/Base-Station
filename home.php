<?php 
	...
	$user = $getFromU->getUserInformation($user_id);
			...
			<ul>
				...
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							<li><a href="<?php echo BASE_URL; ?>"><?php echo $user->username; ?></a></li>
			...
			<div class="info-inner">
				...
				<div class="info-in-body">
					...
					<div class="info-body-name">
						<div class="in-b-name">
							<div><a href="<?php echo BASE_URL.'profile.php?username='.$user->username; ?>"><?php echo $user->screenName; ?></a></div>
							<span><small><a href="<?php echo BASE_URL.'profile.php?username='.$user->username; ?>">@<?php echo $user->username; ?></a></small></span>
						</div><!-- in b name end-->
