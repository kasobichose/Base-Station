	...
	<div class="container-fluid">
		<div class="row" id="mynav">
			<div class="col-md-3">
				...
				<div class="col-sm-12 drop">
					<a href="view-admin.php" style="color:white;background-color:
#5cb85c;padding:10px 25px;"><i class="fa fa-university"></i>&nbsp;View Admin</a>
				</div>
			...
			<div class="col-md-9">
				<div class="col-md-10 col-md-offset-1" style="background-color:white;">
					<div style="margin-bottom:30px;">
						<h3 class="text-success" style="font-weight: bold;">View Administrators</h3>
					</div>
